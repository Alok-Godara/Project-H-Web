        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              MedPortal revolutionizes patient management with intelligent
              document processing, comprehensive medical timelines, and seamless
              provider workflows.
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Powerful tools designed specifically for healthcare providers to
              manage patients efficiently and securely.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="p-8 bg-white rounded-2xl shadow-sm border border-gray-100 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600 leading-relaxed">
                ...
                medications, allergies, and vitals all in one place.
              </p>
            </div>
            ...
            <div className="p-8 bg-white rounded-2xl shadow-sm border border-gray-100 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600 leading-relaxed">
                AI-powered extraction of key medical data from unstructured
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                Focus on what matters most - your patients. Our intelligent
                platform handles the paperwork, organizes medical records, and
                provides instant access to critical patient information.
              </p>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-3">
                  <CheckCircle className="text-green-500" size={20} />
                  <span className="text-gray-700">
                    Chronological medical timeline for each patient
                  </span>
                </div>
                <div className="flex items-center space-x-3">
                  <CheckCircle className="text-green-500" size={20} />
                  <span className="text-gray-700">
                    Real-time collaboration with healthcare teams
                  </span>
                </div>
                <div className="flex items-center space-x-3">
                  <CheckCircle className="text-green-500" size={20} />
      ...
      <section className="py-20 px-6 bg-gray-900">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Join thousands of healthcare providers who trust MedPortal for their
      ...
      <footer className="py-12 px-6 bg-white border-t border-gray-200">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-gray-600">
            © 2024 MedPortal. All rights reserved. HIPAA compliant healthcare
            technology.
          </p>
        </div>
      </footer>
